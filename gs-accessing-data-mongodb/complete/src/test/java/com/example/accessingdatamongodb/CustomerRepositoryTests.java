...
public class CustomerRepositoryTests {
	...
	Customer dave = repository.save(new Customer("Alice", "Smith",new Date("10/10/1980"), getAge("10/10/1980")));
	Customer oliver = repository.save(new Customer("Bob", "Smith",new Date("10/10/1985"), getAge("10/10/1980")));
		carter = repository.save(new  Customer("John", "Smith",new Date("10/10/1987"), getAge("10/10/1980")));
